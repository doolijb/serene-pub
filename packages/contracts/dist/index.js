...
export const rankHybrid = pin(describeTaskType({ id: 'core:task/rank-hybrid@1', timeoutMs: 500, ports: rankPorts }));
export const rankByRecency = pin(describeTaskType({ id: 'core:task/rank-by-recency@1', timeoutMs: 500, ports: rankPorts }));
/** A plugin's ranker — same kind, same shape, so the swap list offers it (16 §5c). */
export const rankSemantic = pin(describeTaskType({ id: 'chariot.recall:rank-semantic@1', timeoutMs: 500, public: true, ports: rankPorts }));
