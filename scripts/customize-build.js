...
// NodeService.kt. Renaming it would be a breaking change for no benefit — and
// it is why the env preload has to be line 1 of THIS file rather than of the
// adapter entry: this is the module Node actually starts with.
requireOrFail(
