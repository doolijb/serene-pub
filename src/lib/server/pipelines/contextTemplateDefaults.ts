 ...
 * move the heading into. Spec 1.4.0 wires `core:query/graph-context@1` in, so
 * the heading moved with the rest and this template is now structure
 * throughout — no block is an exception any more.
 */
