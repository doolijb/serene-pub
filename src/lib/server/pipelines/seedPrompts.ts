...
const SOURCES: PromptSource[] = [
	...
	},
	{
		...
		// The narrator's display name is the one field the reply namespace has no
		// equivalent for, and it is load-bearing: it names the seed line the model
		// continues from, so an empty one seeds a blank speaker.
