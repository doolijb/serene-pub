...
<div
	class="group relative aspect-[3/4] w-full overflow-hidden rounded-xl shadow-md transition-transform hover:scale-[1.02] hover:shadow-xl {character.isFavorite
	...
	>
		...
		{:else}
			<div class="bg-surface-300-700 absolute inset-0 flex items-center justify-center">
				<Icons.UsersRound class="text-surface-400 h-16 w-16" aria-hidden="true" />
			</div>
		{/if}
