	...
	<Portal>
		...
		>
			...
			>
				...
				<article>
					<p class="opacity-60">
						You already have a {entityLabel.toLowerCase()} called "
						<span class="font-semibold">{existingName}</span>
						" that was imported from this same source, but its content
						has changed since then. What would you like to do?
					</p>
				</article>
