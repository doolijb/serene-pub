			...
			<Dialog.Content class="card bg-surface-100-900 p-6 space-y-6 shadow-xl max-w-md">
				...
				<article class="space-y-4">
					<p class="text-surface-700-300 text-sm">
						Choose what to include in the export. World lore, character
						lore, and history entries are always included.
					</p>
					<Switch
					...
					<Switch
						...
						onCheckedChange={(e) => (includeNarrativeGraph = e.checked)}
						class="flex items-center gap-2"
					>
						<Switch.Control class="preset-filled-surface-300-700 data-[state=checked]:preset-filled-primary-500">
							<Switch.Thumb />
