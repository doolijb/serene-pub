# Serene Pub Trademark Policy

**Last Updated:** January 29, 2026

## Overview

"Serene Pub" and the Serene Pub logo are trademarks owned by the original project creator and copyright holder. This trademark policy explains how you can and cannot use these trademarks.

**Important:** This trademark policy is separate from and does not modify the AGPL-3.0 license that covers the Serene Pub software. You can freely use, modify, and distribute the code under AGPL-3.0 terms, but trademark usage has additional restrictions.
...
The following uses of the Serene Pub name are explicitly permitted and encouraged:

### 1. Unmodified Software
...
- ❌ Bundle with adware, advertisements, or bloatware (redistribution only)
...
- Private community instances (e.g., Discord server, game clan)
...
- Offering hosting as a service on a per-client basis
...
- ✅ Running a modified instance for your own personal use or friend group
- ❌ Installing a modified version for a paying client (must rebrand)
...
### 1. Modified Versions for Public Distribution

If you **publicly distribute** a modified version or fork of Serene Pub, you **MUST**:

1. **Choose a different name** that does not include "Serene Pub"
2. **Clearly indicate** it is based on Serene Pub (AGPL attribution requirement)
3. **Maintain existing attribution** (in-app credits must remain intact)
4. **Not use** the Serene Pub logo
...
- Make modifications publicly available if distributed
...
- Running it as a publicly accessible service
- Marketing it as a distinct product
- **Deploying modified versions to clients or third parties** (commercial or non-commercial)
- Providing modified versions to anyone outside your personal/family use

**Key rule:** Modified versions can only use the "Serene Pub" name for your own personal use (yourself, friends, family). Any other distribution or deployment requires rebranding.
...
- Claim your fork is "Serene Pub" without clear differentiation
...
- ❌ Using logo to brand your own product or service
...
Serene Pub is provided as-is under the AGPL-3.0 license for personal, educational, and non-commercial use. While commercial installation and support services are permitted under this trademark policy, please note:

- Serene Pub is **not designed, tested, or warranted for commercial production environments**
- The project maintainers accept **no liability** for commercial use or deployment
- No warranties are provided regarding fitness for commercial purposes
- Commercial users assume all risks and responsibilities
- See the AGPL-3.0 license for full disclaimer of warranties

If you choose to use Serene Pub commercially, you do so at your own risk and responsibility.
...
- Include a link to the official Serene Pub repository

You may add your own attribution for modifications, but existing credits must remain intact.
...
- Example: "Serene Pub MyPlugin" ❌ (suggests official plugin)
...
We're generally permissive for good-faith uses that benefit the community.
...
We're committed to fair and reasonable application of this policy and will work with you to find a solution that protects both the community and the brand.

## Changes to This Policy

This trademark policy may be updated from time to time. Check the "Last Updated" date above for the most recent version.

## Questions?

If you have questions about whether your use is permitted, please ask! We want to support the community while protecting the Serene Pub brand.

---

**Note:** The Serene Pub software itself remains under the AGPL-3.0 license. This trademark policy only governs the use of the Serene Pub name and logo, which are not covered by the software license.
