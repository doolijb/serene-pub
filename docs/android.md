...
- **No SillyTavern import.** Importing characters, personas, and sessions from an existing SillyTavern installation isn't offered on Android. Character cards can still be added individually via file upload (.png/.json).
